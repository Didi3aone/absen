	...
	<div class="panel-body">
		<div class="row-fluid well" style="overflow: hidden">
			...
			<div class="form-group">
				<div><center><h1><b>ABSEN MASUK</b></h1></center></div>
				<div class="col-md-6">
					<?php
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<script language="JavaScript">
						webcam.set_api_url( 'capturemasuk.php' );
				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<td align="center" width="15%"><b>Jam Masuk</b></td>
						</tr>
					</thead>
					<tbody>
					<?php						
						
						$sql= "SELECT karyawan.nik,karyawan.nama,absen_masuk.tgl,absen_masuk.jam_masuk FROM absen_masuk INNER JOIN karyawan ON karyawan.id = absen_masuk.id_karyawan WHERE absen_masuk.tgl=DATE(NOW()) ";
						$hasil = $mysqli->query($sql);
						if($hasil === false) {
							$no = 0;
							trigger_error('Perintah SQL salah: ' . $sql . ' Error: ' . $mysqli->error, E_USER_ERROR);
						...
						while($data = $hasil->fetch_array()){
							...
							echo "<td align=center>$data[jam_masuk]</td>";
							echo "</tr>";
							}
						}
					?>
...
<?php
	...
	if(!empty($_POST['simpan'])){		
		$simpan = $mysqli->prepare("INSERT INTO absen_masuk(id,id_karyawan,tgl,jam_masuk,foto1) VALUES (?,?,?,?,?)");
